    ...
    chernihiv: {
        yavka: {
            ...
            zdacha: {
                ...
                to_stayDepoMedNo: { 4: 15, 6: 20, 8: 25, 10: 30, endAdd: 8, kp: 5 }, // У депо у відстій без мед коміссії без заїзду на станцію //DONE
                to_stayDepoMedYes: { 4: 15, 6: 20, 8: 25, 10: 30, endAdd: 15, kp: 20 }, // У депо у відстій з мед комоссією //DONE

                to_repairsDepoMedNo: { 4: 22, 6: 31, 8: 39, 10: 48, endAdd: 8, kp: 5 }, //У депо у ремонт ТО без мед коміссії без заїзду на станцію //DONE
    ...
    chernihiv: {
        yavka: {
            ...
            zdacha: {
                ...
                to_stayDepoMedNo: { 4: 0, 6: 30, 8: 35, 10: 0, endAdd: 8, kp: 5 }, // У депо у відстій без мед коміссії без заїзду на станцію
                to_stayDepoMedYes: { 4: 0, 6: 30, 8: 35, 10: 0, endAdd: 15, kp: 20 }, // У депо у відстій з мед комоссією 

                to_repairsDepoMedNo: { 4: 0, 6: 41, 8: 49, 10: 0, endAdd: 8, kp: 5 }, //У депо у ремонт ТО без мед коміссії без заїзду на станцію
